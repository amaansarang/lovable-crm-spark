...
import { BarChart3, Building2, Calendar, ChevronLeft, ChevronRight, Contact2, LayoutDashboard, ListTodo, Mail, MessageCircle, Settings, Users } from "lucide-react";
...
const Sidebar = () => {
  ...
  return <div className={cn("flex flex-col h-screen bg-sidebar text-sidebar-foreground border-r border-sidebar-border transition-all duration-300", collapsed ? "w-16" : "w-64")}>
      <div className="flex items-center justify-between p-4 border-b border-sidebar-border">
        {!collapsed && <h1 className="font-bold text-xl">Leyta Genuine CRM</h1>}
      ...
      <div className="overflow-y-auto flex-grow crm-scrollbar">
        <nav className="px-2 py-4">
          <div className="mb-6">
            {!collapsed && <p className="px-4 mb-2 text-xs uppercase text-sidebar-foreground/60">Main</p>}
            <ul>
